        ...
        <div class="container">
          ...
          <div id="navbarcollapse" class="collapse navbar-collapse">
            <ul class="navbar-nav ml-auto">
              <li class="nav-item"><a href="a_homepage.php" class="nav-link active">Home</a>
              </li>
              <li class="nav-item"><a href="a_profile.php" class="nav-link ">Profile</a>
              </li>
              <li class="nav-item"><a href="a_data.php" class="nav-link active">Data</a>
              </li>
              <li class="nav-item"><a href="a_user.php" class="nav-link">User</a>
              </li>
