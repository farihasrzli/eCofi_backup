        ...
        <div class="container">
          ...
          <div id="navbarcollapse" class="collapse navbar-collapse">
            <ul class="navbar-nav ml-auto">
              <li class="nav-item"><a href="u_homepage.php" class="nav-link active ">Home</a>
              </li>
              <li class="nav-item"><a href="u_profile.php" class="nav-link ">Profile</a>
              </li>
              <li class="nav-item"><a href="u_subject.php" class="nav-link ">Subject</a>
              </li>
              <li class="nav-item"><a href="u_manual.php" class="nav-link ">Manual</a>
              </li>
        ...
        <main class="post blog-post col-lg-8"> 
          <div class="container">
            <div class="post-single">
              <div class="post-thumbnail"><h3>Notice</h3></div>
              <div class="post-details">
                <blockquote class="blockquote">
                <div class="post-meta d-flex justify-content-between">
                  <div class="category"><a href="#">Business</a><a href="#">Financial</a></div>
                </div>
                <h2>Home Page Testing<a href="#"></a></h2>
                <p class="lead">Contain mesej sila bebel sini</p>
            ...
            <div class="post-single">
              <div class="post-thumbnail"><h3>Reminder</h3></div>
              <div class="post-details">
                <blockquote class="blockquote">
                <div class="post-meta d-flex justify-content-between">
                  <div class="category"><a href="#">Business</a><a href="#">Financial</a></div>
            ...
            <div class="post-single">
              <div class="post-thumbnail"><h3>Subjects</h3></div>
              <div class="post-details">
                <blockquote class="blockquote">
                <div class="post-meta d-flex justify-content-between">
                  <div class="category"><a href="#">Business</a><a href="#">Financial</a></div>
