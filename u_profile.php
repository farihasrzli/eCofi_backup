        ...
        <div class="container">
          ...
          <div id="navbarcollapse" class="collapse navbar-collapse">
            <ul class="navbar-nav ml-auto">
              <li class="nav-item"><a href="u_homepage.php" class="nav-link ">Home</a>
              </li>
              <li class="nav-item"><a href="u_profile.php" class="nav-link active">Profile</a>
              </li>
