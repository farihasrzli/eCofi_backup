        ...
        <div class="container">
          ...
          <div id="navbarcollapse" class="collapse navbar-collapse">
            <ul class="navbar-nav ml-auto">
              <li class="nav-item"><a href="testhome.html" class="nav-link">Home</a>
              </li>
              <li class="nav-item"><a href="testprofile.html" class="nav-link ">Profile</a>
              </li>
              <li class="nav-item"><a href="testsubject.html" class="nav-link ">Subject</a>
              </li>
              <li class="nav-item"><a href="testmanual.html" class="nav-link active">Manual</a>
              </li>
